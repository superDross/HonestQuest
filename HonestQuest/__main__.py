...
from HonestQuest.utils.print_text import centre_string, midscreen, print_middle
...
def intiate_overworld(height=40, width=93):
    ...
    world = OverWorld(height=int(height * 0.9), width=int(width / 2))
    return world
...
def animate_overworld(overworld, hero):
    ...
    while n != 1:
        ...
        overworld.move_hero()
        if (
            overworld.field.x == overworld.field.x_store
